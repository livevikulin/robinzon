...
define(['jquery', 'webui-popover'], function ($) {
    ...
    function initProductCardMap() {
        ...
        var BalloonContentLayout = ymaps.templateLayoutFactory.createClass(
            ...
            '<span class="b-delivery-list__col b-delivery-list__col--color b-delivery-list__col{{properties.color}}"></span> {{properties.addr}}</span>' + // eslint-disable-line max-len
            '<span class="b-delivery-list__col b-delivery-list__col--all">' +
            '<span class="b-delivery-list__col b-delivery-list__col--phone">{{properties.telephone}}</span>' +
...
'                        <input class="b-radio__input js-shop-color" type="radio" name="map-color-'+id+'" id="id-map-color-'+id+'-'+i+'">'+
'                            <label class="b-radio__label b-radio__label--map-color" for="id-map-color-'+id+'-'+i+'" title="'+this.name+'">'+
'                                <span class="b-radio__circle b-radio__circle--map-card" data-color="'+this.color+'"></span>'+
'                            </label>'+
'                        </div>'+
'                     </li>';
        ...
        var makeHtml4shopProduct = function (baloons) {
            ...
            for (j = 0; j < baloons.length; j++) {
                ...
                '                <div class="b-delivery-list__heading">'+shop.name+'</div>'+
